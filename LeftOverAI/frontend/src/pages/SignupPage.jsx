...
const SignupPage = () => {
    ...
    const validateForm = () => {
      ...
      if(!formData.password.length > 6) return toast.error("Password must be atleast of 6 charecters");
    ...
    return (
      <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <AuthImagePattern
          ...
          subtitle = "Connect with our friends, share moments, and stay in touch with your loved ones "
        />
